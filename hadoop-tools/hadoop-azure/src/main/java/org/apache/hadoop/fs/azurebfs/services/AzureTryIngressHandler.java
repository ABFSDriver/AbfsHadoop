 ...
 */
public class AzureTryIngressHandler extends AzureIngressHandler {
  ...
  private final AzureTryBlockManager tryBlockManager;
   ...
   */
  public AzureTryIngressHandler(AbfsOutputStream abfsOutputStream,
    ...
    this.eTag = eTag;
    if (blockManager instanceof AzureTryBlockManager) {
      this.tryBlockManager = (AzureTryBlockManager) blockManager;
    } else {
      this.tryBlockManager = new AzureTryBlockManager(this.abfsOutputStream,
...
//    }
  ...
  protected void writeAppendBlobCurrentBufferToService(Instant startTime) throws IOException {
    AbfsBlock activeBlock = tryBlockManager.getActiveBlock();
    ...
    tryBlockManager.clearActiveBlock();
